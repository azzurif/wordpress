 ...
 * Description:       Cozy Blocks - Page Builder Blocks for FSE and Gutenberg Editor,Gutenberg Blocks, Post Blocks, Slider Blocks, Elementor Widgets and Layouts
 * Version:           1.3.7
 * Author:            CozyThemes
...
define( 'COZY_ADDONS_VERSION', '1.3.7' );
...
if ( ! class_exists( 'Cozy_Addons' ) ) :
	final class Cozy_Addons {
		...
		public function init() {
			...
			// Register cozy block.
			if ( file_exists( COZY_ADDONS_PLUGIN_DIR . 'cozy-blocks/cozy-block.php' ) ) {
